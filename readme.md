...
- [CoffeeIsAllYouNeed/Invisible-Driver](https://github.com/CoffeeIsAllYouNeed/Invisible-Driver#readme) - A Brain-Computer Interface designed to 'drive a car using thoughts'. Unsupervised machine learning is used to classify EEG signals into 'attentive' and 'relaxed' states.
